    ...
    public static void main(String[] args) { 
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                IPlayer player2 = new Hexmastery("HexMastery"); 
                new Board(player1 , player2,4 /*mida*/,  5/*s*/, false); //player, mida de tauler i al principi fer.ho amb 9 i despres els tests fer-ho amb 11

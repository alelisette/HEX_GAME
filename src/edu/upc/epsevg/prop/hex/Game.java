    ...
    public static void main(String[] args) { 
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                //IPlayer player1 = new Hexmastery("HexMastery", 8, 5);              
                IPlayer player2 = new Hexmastery("HexMastery", 5); // usa IDS
                
                new Board(player1 , player2, 5 /*mida*/,  10 /*s*/, false); //player, mida de tauler i al principi fer.ho amb 9 i despres els tests fer-ho amb 11
